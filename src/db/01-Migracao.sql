...
ALTER TABLE dbo.Agenda ADD CONSTRAINT PK_Agenda PRIMARY KEY CLUSTERED (Id);
ALTER TABLE dbo.Agenda ADD CONSTRAINT FK_Cep FOREIGN KEY (CepId) REFERENCES Cep(Id);
